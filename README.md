...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `109.9µs` | `1.1ms` |
| [Day 2](./src/bin/02.rs) | `57.6ms` | `202.8ms` |
| [Day 3](./src/bin/03.rs) | `57.7µs` | `124.4µs` |
| [Day 4](./src/bin/04.rs) | `3.0ms` | `22.2ms` |
| [Day 5](./src/bin/05.rs) | `164.8µs` | `68.3µs` |
| [Day 6](./src/bin/06.rs) | `105.4µs` | `153.2µs` |
| [Day 7](./src/bin/07.rs) | `28.0µs` | `28.3µs` |
